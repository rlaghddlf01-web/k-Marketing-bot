...
def main():
    print("\n" + "=" * 70)
    print("🔑 [K-Market] 레딧(Reddit) 실제 크롬 계정 1회 로그인 도구")
    print("=" * 70)
    print("1. 순수 크롬 브라우저가 열립니다 (자동화 제한 없음).")
    print("2. 화면에서 [Continue with Google] (rlaghddlf01@gmail.com)을 눌러 로그인해 주세요.")
    print("3. 우측 상단에 내 아바타(프로필)가 뜨면 로그인이 완료된 것입니다.")
    print("4. 로그인이 끝나면 크롬 창을 [X] 눌러 닫아주시면 세션이 영구 저장됩니다.")
    print("=" * 70 + "\n")

    profile_dir = BASE_DIR / "data" / "reddit_profiles" / "kmarket"
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            cookie_file = profile_dir.parent / "kmarket_cookies.json"
    ...
    print("\n🎉 [축하합니다] 케이마켓 레딧 로그인 세션 연동이 100% 완료되었습니다!")
    print("이제부터는 크롬 창을 닫아두셔도 봇이 무인으로 활동합니다.\n")
