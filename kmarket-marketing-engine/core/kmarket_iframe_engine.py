"""
KMarketIFrameEngine - [KTRS 마켓 실제 웹사이트 9:16 모바일 iFrame 캡처 & 렌더링 엔진]
- 실제 KTRS 마켓 웹사이트(https://ktrs-market.vercel.app/)의 모바일 웹뷰를 9:16 (1080x1920)로 로딩
...
class KMarketIFrameEngine:
    """
    📱 KTRS 마켓 9:16 모바일 웹뷰 iFrame 전담 렌더러
    """
    ...
    def get_mobile_iframe_url(self, lang: str = "vi", category: str = "all") -> str:
        """17개국 언어 및 카테고리가 적용된 KTRS 마켓 실제 모바일 웹 URL 생성 (서브패스 라우팅)"""
    ...
    def render_iframe_cardnews_set(self, lang: str = "vi") -> List[Path]:
        """
        9:16 세로형 모바일 웹뷰 기반 KTRS 마켓 4장 카드뉴스 렌더링
        """
