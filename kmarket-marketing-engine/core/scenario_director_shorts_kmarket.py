...
KMARKET_60_THEMES = [
    # ── [1. 전국 20대 대학가 캠퍼스 0원 나눔편 (20개 - 100% 1인 직접 수령 소형템)] ──
    {"id": "univ_yonsei_sinchon", "cat": "campus", "name": "신촌 연세대 원룸 선배들의 0원 미니 스탠드 나눔", "target": "신촌 연세대/서강대/이대", "item": "LED 학습 스탠드 & 멀티탭"},
    {"id": "univ_korea_anam", "cat": "campus", "name": "안암 고려대 자취방 미니 믹서기 득템 라이브", "target": "안암 고려대 캠퍼스", "item": "휴대용 미니 믹서기 & 텀블러"},
    {"id": "univ_skku_hyehwa", "cat": "campus", "name": "혜화 성균관대 석박사 연구실 스탠드 0원 나눔", "target": "혜화 성균관대/대학로", "item": "LED 무드등 스탠드 & 데스크 정리함"},
    {"id": "univ_khu_hoegi", "cat": "campus", "name": "회기 경희대·외대 유학생 멀티쿠커 0원 득템", "target": "회기 경희대/한국외대", "item": "자취생 멀티쿠커 & 라면포트"},
    {"id": "univ_hanyang_wangsimni", "cat": "campus", "name": "왕십리 한양대 공대생 전자레인지 0원 릴레이", "target": "왕십리 한양대 원룸촌", "item": "디지털 전자레인지 & 토스터기"},
    {"id": "univ_snu_gwanak", "cat": "campus", "name": "신림·서울대입구 원룸 주방 스타터세트 무료 나눔 피드", "target": "관악 서울대입구/낙성대", "item": "주방 식기 & 조리도구 세트"},
    {"id": "univ_cau_heukseok", "cat": "campus", "name": "흑석 중앙대 자취촌 귀국 선배 생활가전 나눔", "target": "흑석 중앙대/노량진", "item": "쿠쿠 전기밥솥 & 주방용품"},
    {"id": "univ_sogang_sinchon", "cat": "campus", "name": "서강대 정문 앞 3초 번개 직거래 성공 현장", "target": "마포 신촌/서강대", "item": "접이식 수납함 & 이동식 행거"},
    {"id": "univ_ewha_daehyeon", "cat": "campus", "name": "이화여대 앞 원룸 LED 탁상거울 0원 득템", "target": "이대역/대현동 원룸", "item": "LED 조명 탁상거울 & 화장품 정리함"},
    {"id": "univ_kwangwoon_nowon", "cat": "campus", "name": "노원 광운대 원룸 24인치 모니터 꿀매물 피드", "target": "노원 광운대/과기대", "item": "24인치 슬림 모니터"},
    {"id": "univ_uos_dongdaemun", "cat": "campus", "name": "동대문 서울시립대 정문 앞 극세사 이불 나눔", "target": "전농동 서울시립대", "item": "포근한 극세사 차렵이불 세트"},
    {"id": "univ_skku_suwon", "cat": "campus", "name": "수원 율전 성균관대 자연캠 무선청소기 득템 라이브", "target": "수원 율전동/성대역", "item": "무선 스틱 청소기 & 미니 가습기"},
    {"id": "univ_ajou_suwon", "cat": "campus", "name": "수원 아주대 삼거리 원룸 0원 가전 득템기", "target": "수원 아주대/원천동", "item": "대용량 에어프라이어 & 커피포트"},
    {"id": "univ_inha_incheon", "cat": "campus", "name": "인천 인하대 후문 원룸 3단 데스크 서랍장 무료 나눔", "target": "인천 인하대 후문가", "item": "3단 데스크 미니 서랍장"},
    {"id": "univ_kaist_daejeon", "cat": "campus", "name": "대전 카이스트·충남대 궁동 0원 생활가전 피드", "target": "대전 유성구 궁동", "item": "휴대용 초음파 가습기 & 스탠드"},
    {"id": "univ_pnu_busan", "cat": "campus", "name": "부산대 정문 앞 원룸 접이식 밥상 0원 나눔 대방출", "target": "부산 금정구 장전동", "item": "원목 접이식 좌식 테이블"},
    {"id": "univ_knu_daegu", "cat": "campus", "name": "대구 경북대 복현동 원룸 전기장판 0원 나눔", "target": "대구 북구 복현동", "item": "극세사 따뜻한 전기장판"},
    {"id": "univ_jnu_gwangju", "cat": "campus", "name": "광주 전남대 후문 유학생 무빙세일 핫딜", "target": "광주 북구 용봉동", "item": "미니 청소기 & 제습기"},
    {"id": "univ_cnu_cheongju", "cat": "campus", "name": "청주 충북대 중문 원룸 스탠드 옷걸이 0원 무료 득템", "target": "청주 서원구 사창동", "item": "스탠드 시스템 옷걸이 행거"},
    {"id": "univ_jbnu_jeonju", "cat": "campus", "name": "전주 전북대 구정문 앞 생활용품 무료 나눔", "target": "전주 덕진동 전북대", "item": "패브릭 수납박스 & 접이식 테이블"},

    # ── [2. 가구·가전 품목별 득템편 (15개 - 100% 1인 직접 수령 소형템)] ──
    {"id": "item_multi_cooker", "cat": "item", "name": "자취생 필수 만능 멀티쿠커 0원 득템 꿀팁", "target": "전국 대학가/원룸촌", "item": "디지털 만능 멀티쿠커"},
    {"id": "item_steam_iron", "cat": "item", "name": "출근·등교 필수 핸디형 스팀다리미 0원 직거래", "target": "서울/경기 원룸 밀집지역", "item": "핸디형 파워 스팀다리미"},
    {"id": "item_blender", "cat": "item", "name": "건강 주스 만들기 초고속 미니 블렌더 0원 나눔", "target": "대학가 자취방", "item": "초고속 미니 믹서기 & 텀블러"},
    {"id": "item_humidifier", "cat": "item", "name": "환절기 필수 대용량 무소음 가습기 0원 수령기", "target": "유학생 거주지역", "item": "대용량 무소음 가습기"},
    ...
    {"id": "item_3tier_drawer", "cat": "item", "name": "원룸 정리 끝판왕 3단 패브릭 서랍장 0원 꿀매물", "target": "대학가 원룸", "item": "패브릭 3단 수납서랍장"},
    {"id": "item_system_hanger", "cat": "item", "name": "옷 정리 깔끔 시스템 이동식 행거 나눔", "target": "전국 원룸촌", "item": "2단 조립식 드레스룸 행거"},
    ...
    {"id": "item_desk_mirror", "cat": "item", "name": "외출 필수 LED 조명 탁상거울 0원 직거래", "target": "원룸 밀집지역", "item": "LED 조명 탁상거울"},
    ...
    # ── [3. 이사 & 자취 리얼 에피소드편 (15개 - 100% 1인 직접 수령 소형템)] ──
    {"id": "story_senior_farewell", "cat": "story", "name": "졸업 귀국 선배가 물려준 0원 자취 가전 세트", "target": "대학교 정문 앞 직거래", "item": "선배가 아끼던 주방가전 3종"},
    {"id": "story_sticker_zero_fee", "cat": "story", "name": "원룸 방빼기 안 쓰는 소형가전 0원 나눔 정리", "target": "이사 준비 자취생", "item": "상태 좋은 박스 포장 소형가전"},
    {"id": "story_first_room_setup", "cat": "story", "name": "0원 나눔 가전으로 완성한 한국 첫 자취방 랜선집들이", "target": "한국 입국 신입생", "item": "0원 나눔 알짜 가전 풀세트"},
    {"id": "story_roommate_deal", "cat": "story", "name": "룸메이트와 둘이서 0원으로 방 꾸민 썰", "target": "2인 거주 유학생", "item": "공동생활 소형 주방가전"},
    {"id": "story_rainy_day_warmth", "cat": "story", "name": "비오는 날 이웃이 우산 씌워주며 온수매트 나눔해준 실화", "target": "동네 이웃 직거래", "item": "따뜻한 정이 담긴 온수매트"},
    {"id": "story_lightning_meetup", "cat": "story", "name": "채팅하고 10분 만에 집 앞 직거래 성공기", "target": "동네 생활권 직거래", "item": "10분 컷 무료 소형가전"},
    {"id": "story_safe_campus_gate", "cat": "story", "name": "학생증 인증으로 100% 안전한 대학교 정문 거래", "target": "여학생 안심 직거래", "item": "안심 인증 0원 물품"},
    {"id": "story_empty_floor_tears", "cat": "story", "name": "차가운 방바닥에서 울던 날 K-Market을 만났다", "target": "외국인 입국 초기", "item": "첫날 구원해 준 전기장판 & 이불"},
    {"id": "story_friendly_korean_uncle", "cat": "story", "name": "한국인 집주인 아저씨가 추천해 준 0원 나눔 앱", "target": "원룸 거주자", "item": "집주인 추천 필수 생활가전"},
    {"id": "story_weekend_flea_market", "cat": "story", "name": "주말 동네 주민 무빙세일에서 0원으로 득템하기", "target": "주말 벼룩시장", "item": "생활 소품 & 주방기구"},
    {"id": "story_saving_millions", "cat": "story", "name": "가전값 150만원 아껴서 학비 보탠 유학생 후기", "target": "알뜰 유학생", "item": "150만원 상당 0원 가전"},
    {"id": "story_subway_exit_trade", "cat": "story", "name": "지하철 2호선 역세권 출구 앞 1분 직거래", "target": "지하철역 출구", "item": "간편 캐리어 수령 물품"},
    {"id": "story_clean_state_shock", "cat": "story", "name": "새것 같은 상태에 깜짝 놀란 0원 나눔 후기", "target": "상태 A급 매물", "item": "거의 새것 같은 A급 소형가전"},
    {"id": "story_korean_culture_gift", "cat": "story", "name": "나눔 받으며 한국의 정을 처음 배운 외국인", "target": "다문화 이웃", "item": "따뜻한 나눔의 소형 선물"},
    {"id": "story_graduating_relief", "cat": "story", "name": "귀국 전날 모든 짐 0원 나눔으로 완벽 정리 완료", "target": "귀국 예정자", "item": "전체 이삿짐 홀가분 정리"},

    # ── [4. 전국 10대 산업단지 기숙사 & 원룸편 (10개 - 100% 1인 직접 수령 소형템)] ──
    {"id": "ind_ansan_wongok", "cat": "industry", "name": "안산 원곡동 다문화거리 근로자 원룸 0원 가전", "target": "안산 반월공단/원곡동", "item": "핸디형 스팀다리미 & 무선포트"},
    {"id": "ind_suwon_yeongtong", "cat": "industry", "name": "수원 영통 테크노밸리 기숙사 무빙세일 핫딜", "target": "수원 영통/삼성전자 산단", "item": "전자레인지 & 미니 청소기"},
    {"id": "ind_pyeongtaek_godeok", "cat": "industry", "name": "평택 고덕 삼성캠퍼스 앞 원룸 방빼기 0원 피드", "target": "평택 고덕/서정리역", "item": "이동식 3단 수납 트롤리 카트"},
    {"id": "ind_hwaseong_hyangnam", "cat": "industry", "name": "화성 향남 제약공단 외국인 근로자 0원 나눔", "target": "화성 향남/발안 산단", "item": "온풍기 & 전기장판"},
    {"id": "ind_guro_gasan", "cat": "industry", "name": "구로·가산 디지털단지 오피스텔 무빙세일", "target": "구로디지털/가산디지털", "item": "데스크 스탠드 조명 & 멀티탭"},
    {"id": "ind_asan_tangjeong", "cat": "industry", "name": "아산 탕정 디스플레이단지 원룸 생활용품 나눔", "target": "아산 탕정/천안 불당", "item": "미니 밥솥 & 식기 세트"},
    {"id": "ind_cheonan_baekseok", "cat": "industry", "name": "천안 백석·성성공단 기숙사 0원 가전 대방출", "target": "천안 백석공단/두정동", "item": "디지털 에어프라이어 & 토스터기"},
    {"id": "ind_cheongju_ochang", "cat": "industry", "name": "청주 오창 과학산단 원룸 0원 나눔 라이브", "target": "청주 오창산단/오송", "item": "디지털 5L 에어프라이어"},
    {"id": "ind_ulsan_onsan", "cat": "industry", "name": "울산 온산 국가산단 엔지니어 기숙사 무빙세일", "target": "울산 온산/남구 달동", "item": "쿠쿠 압력밥솥 & 소형 전자레인지"},
